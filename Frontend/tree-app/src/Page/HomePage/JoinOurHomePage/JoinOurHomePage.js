  ...
  return (
    <div className="joinOur w-full h-auto mb-10 container mx-auto lg:px-24 md:px-24 sm:px-5 mb:px-5 ">
        <div className="lg:flex flex-wrap bg-[#e9e8e8] rounded-[20px]">
            ...
            <div className="lg:w-1/2 md:w-full">
                <img className="w-full h-full rounded-r-[20px]" src="https://giadinh.mediacdn.vn/296230595582509056/2021/12/10/cay-day-nhen-tai-vuon-mat-troi-16389431430001385199795-1639096956056-16390969563881340664118.jpg" />
            </div>
        </div>
    </div>
  );
